...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_coursePlace = (TextView)convertView.findViewById(R.id.tv_coursePlace);
	  holder.tv_courseTime = (TextView)convertView.findViewById(R.id.tv_courseTime);
	  ...
	  holder.tv_coursePlace.setText("上课地点：" + mData.get(position).get("coursePlace").toString());
	  holder.tv_courseTime.setText("上课时间：" + mData.get(position).get("courseTime").toString());
	  holder.tv_courseHours.setText("总学时：" + mData.get(position).get("courseHours").toString());
