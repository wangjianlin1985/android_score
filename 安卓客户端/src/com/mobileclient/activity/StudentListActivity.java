				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new StudentSimpleAdapter(StudentListActivity.this, list,
	        					...
	        					new String[] { "studentNo","classObj","name","sex","birthday","studentPhoto","telephone" },
	        					new int[] { R.id.tv_studentNo,R.id.tv_classObj,R.id.tv_name,R.id.tv_sex,R.id.tv_birthday,R.id.iv_studentPhoto,R.id.tv_telephone,},lv);
