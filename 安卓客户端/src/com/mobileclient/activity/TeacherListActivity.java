				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new TeacherSimpleAdapter(TeacherListActivity.this, list,
	        					...
	        					new String[] { "teacherNo","name","sex","birthday","telephone","email" },
	        					new int[] { R.id.tv_teacherNo,R.id.tv_name,R.id.tv_sex,R.id.tv_birthday,R.id.tv_telephone,R.id.tv_email,},lv);
