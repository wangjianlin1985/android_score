...
public class ScoreSimpleAdapter extends SimpleAdapter { 
	/*需要绑定的控件资源id*/
    private int[] mTo;
    /*map集合关键字数组*/
...
/*需要绑定的数据*/
    ...
    public ScoreSimpleAdapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to,ListView listView) { 
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  if (convertView == null) convertView = mInflater.inflate(R.layout.score_list_item, null);
	  convertView.setTag("listViewTAG" + position);
	  holder = new ViewHolder(); 
	  /*绑定该view各个控件*/
	  holder.tv_scoreId = (TextView)convertView.findViewById(R.id.tv_scoreId);
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_scoreId.setText("成绩id：" + mData.get(position).get("scoreId").toString());
	  ...
	  holder.tv_courseScore.setText("课程成绩：" + mData.get(position).get("courseScore").toString());
	  holder.tv_evaluate.setText("学生评价：" + mData.get(position).get("evaluate").toString());
	  /*返回修改好的view*/
	  return convertView; 
    } 
