...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    <td width=30%>邮件:</td>
    <td width=70%><input id="teacher.email" name="teacher.email" type="text" size="30" value='<%=teacher.getEmail() %>'/></td>
  </tr>

  <tr>
    <td width=30%>地址:</td>
    <td width=70%><input id="teacher.address" name="teacher.address" type="text" size="50" value='<%=teacher.getAddress() %>'/></td>
  </tr>
