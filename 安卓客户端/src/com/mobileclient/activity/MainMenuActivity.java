...
public class MainMenuActivity extends Activity {
    ...
    public class ImageAdapter extends BaseAdapter {
        ...
        private String[] menuString = {"班级管理","学生管理","老师管理","课程管理","成绩管理","课件管理"};
        ...
        public View getView(int position, View convertView, ViewGroup parent) { 
			...
			iv.setImageResource(mThumbIds[position]); 
			  switch (position) {
				...
				case 4:
					// 成绩管理监听器
					view.setOnClickListener(scoreLinstener);
					break;
				case 5:
					// 课件管理监听器
    ...
    OnClickListener scoreLinstener = new OnClickListener() {
		public void onClick(View v) {
			Intent intent = new Intent();
			// 启动成绩管理Activity
			intent.setClass(MainMenuActivity.this, ScoreListActivity.class);
			startActivity(intent);
		}
	};
