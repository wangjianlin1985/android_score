				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new ClassInfoSimpleAdapter(ClassInfoListActivity.this, list,
	        					...
	        					new String[] { "classNo","className","bornDate","headerName" },
	        					new int[] { R.id.tv_classNo,R.id.tv_className,R.id.tv_bornDate,R.id.tv_headerName,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < classInfoList.size(); i++) {
				...
				map.put("headerName", classInfoList.get(i).getHeaderName());
				list.add(map);
			}
		} catch (Exception e) { 
