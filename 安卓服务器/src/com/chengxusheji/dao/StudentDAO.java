...
public class StudentDAO {
    ...
    public ArrayList<Student> QueryStudentInfo(String studentNo,ClassInfo classObj,String name,String birthday,String telephone,int currentPage) { 
    	Session s = factory.getCurrentSession();
    ...
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public ArrayList<Student> QueryStudentInfo(String studentNo,ClassInfo classObj,String name,String birthday,String telephone) { 
    	Session s = factory.getCurrentSession();
    	String hql = "From Student student where 1=1";
    	if(!studentNo.equals("")) hql = hql + " and student.studentNo like '%" + studentNo + "%'";
    	if(null != classObj && !classObj.getClassNo().equals("")) hql += " and student.classObj.classNo='" + classObj.getClassNo() + "'";
    ...
    /*计算总的页数和记录数*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public void CalculateTotalPageAndRecordNumber(String studentNo,ClassInfo classObj,String name,String birthday,String telephone) {
        Session s = factory.getCurrentSession();
        String hql = "From Student student where 1=1";
        if(!studentNo.equals("")) hql = hql + " and student.studentNo like '%" + studentNo + "%'";
        if(null != classObj && !classObj.getClassNo().equals("")) hql += " and student.classObj.classNo='" + classObj.getClassNo() + "'";
